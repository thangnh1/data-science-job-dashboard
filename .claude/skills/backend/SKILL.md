...
3. **Execute migrations using the project's tool**: When a schema spec is provided (forward DDL + rollback DDL + deployment risk notes), wrap it in the project's migration tool. Detect the tool from `CLAUDE.md` and project dependencies:
